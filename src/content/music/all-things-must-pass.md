...
Phil Spector's wall-of-sound production is a lot, and it doesn't always serve the songs, but "Isn't It a Pity" and the title track cut through regardless. Harrison's voice was never the flashiest, but it's the most sincere-sounding thing on the record by a wide margin.

A triple album that mostly earns its length, which is rarer than it should be.